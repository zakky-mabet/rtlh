...
?>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="number" name="nilai_anggaran" class="form-control" value="<?php echo set_value('nilai_anggaran'); ?>">
					...
					<div class="col-md-8">
						<select name="jenis" class="form-control input-sm select2">
							...
							<?php foreach ($this->dekonsentrasi->get_all_jenis() as $key => $value): ?>
								<option value="<?php echo $value->id ?>" <?php if($this->input->post('jenis')==$value->id) echo 'selected'; ?>><?php echo $value->nama_jenis ?></option>
							<?php endforeach ?>
						</select>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="text" name="tanggal_kegiatan" id="datepicker" class="form-control" value="<?php echo set_value('tanggal_kegiatan'); ?>">
