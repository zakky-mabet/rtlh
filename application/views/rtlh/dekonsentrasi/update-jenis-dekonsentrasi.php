...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					<label for="nama_jenis" class="control-label col-md-3 col-xs-12">Jenis Kegiatan: <strong class="text-red">*</strong></label>
					<div class="col-md-8">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<textarea name="keterangan" rows="4" class="form-control"><?php echo $get->keterangan; ?></textarea>
					<p class="help-block"><?php echo form_error('keterangan', '<small class="text-red">', '</small>'); ?></p>
				</div>
			</div>
			<div class="box-footer with-border">
				<div class="col-md-4 col-xs-5">
					<a href="<?php echo site_url('dekonsentrasi/jenis') ?>" class="btn btn-app pull-right">
