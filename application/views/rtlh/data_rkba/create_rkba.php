			...
			<div class="box-body" style="margin-top: 10px;">
					...
					<div class="col-md-9">
						<select name="id_daftar_bencana" class="form-control select2">
							...
							<?php foreach ($this->data_rkba->get_all_daftar_bencana() as $value): ?>
								<option value="<?php echo $value->id_bencana ?>" <?php if(set_value('id_daftar_bencana')==$value->id_bencana) echo 'selected'; ?>><?php echo $value->nama ?></option>
							<?php endforeach ?>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<select name="jenis_kerusakan" class="form-control select2">
							<option value="">-- PILIH --</option>
							<option value="Ringan" <?php if(set_value('jenis_kerusakan')=='Ringan') echo 'selected'; ?>>Ringan</option>
							<option value="Sedang" <?php if(set_value('jenis_kerusakan')=='Sedang') echo 'selected'; ?>>Sedang</option>
							<option value="Berat" <?php if(set_value('jenis_kerusakan')=='Berat') echo 'selected'; ?>>Berat</option>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<select name="jenis_kegiatan" class="form-control select2">
							<option value="">-- PILIH --</option>
							<option value="Rehab" <?php if(set_value('jenis_kegiatan')=='Rehab') echo 'selected'; ?>>Rehab</option>
							<option value="Pembangunan Baru" <?php if(set_value('jenis_kegiatan')=='Pembangunan Baru') echo 'selected'; ?>>Pembangunan Baru</option>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-6 ">
								<input type="text" placeholder="Latitude" name="latitude" class="form-control" value="<?php echo set_value('latitude'); ?>">
								<p class="help-block"><?php echo form_error('latitude', '<small class="text-red">', '</small>'); ?></p>
							</div>
							<div class="col-md-6">
								<input type="text" placeholder="Longitude" name="longitude" class="form-control" value="<?php echo set_value('longitude'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" name="jumlah_bantuan" class="form-control" value="<?php echo set_value('jumlah_bantuan'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<select name="sumber_anggaran" class="form-control select2" style="width: 100%">
							<option value="">-- PILIH --</option>
							<option value="APBN" <?php if(set_value('sumber_anggaran')=='APBN') echo 'selected'; ?>>APBN
							<option value="DAK" <?php if(set_value('sumber_anggaran')=='DAK') echo 'selected'; ?>>DAK
							<option value="APBD1" <?php if(set_value('sumber_anggaran')=='APBD1') echo 'selected'; ?>>APBD 1
							<option value="APBD2" <?php if(set_value('sumber_anggaran')=='APBD2') echo 'selected'; ?>>APBD 2
							<option value="CSR" <?php if(set_value('sumber_anggaran')=='CSR') echo 'selected'; ?>>CSR
							<option value="DABA" <?php if(set_value('sumber_anggaran')=='DABA') echo 'selected'; ?>>DABA
							<option value="Lainnya" <?php if(set_value('sumber_anggaran')=='Lainnya') echo 'selected'; ?>>Lainnya
						</select>
