    ...
    <div class="col-md-3">
        <div class="box box-solid no-print" id="sticker">
            <div class="box-header with-border">
                <h3 class="box-title">Statistik RKBA</h3>
            </div>
                ...
                <form action="" method="get" role="form">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="tahun" class="form-control input-sm select2">
                                   ...
                                   <?php foreach ($this->mstatistik->get_tahun_rkba_distinct() as $key => $value): ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <a href="<?php echo site_url('statistik/rkba') ?>" class="btn btn-warning hvr-shadow top" style="margin-left: 10px;"><i class="fa fa-times"></i> Reset</a>
                            </div>
                        </div>
...
var chart = new Highcharts.Chart({
    ...
    title: {
        text: 'Grafik Jumlah Rumah Korban Bencana Alam'
    },
    subtitle: {
    ...
    series: [
        <?php foreach ($this->mstatistik->get_kab_rkba_distinct() as $key => $value) { ?>
            {  name:'<?php echo $this->mstatistik->get_kabupaten($value->regency)->name_regencies ?>', data: [<?php echo $this->mstatistik->get_kab_rkba_num_rows($value->regency) ?>] },
        <?php } ?>    
    ]
