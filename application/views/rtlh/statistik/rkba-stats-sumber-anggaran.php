                ...
                <form action="" method="get" role="form">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <a href="<?php echo site_url('statistik/rkba_sumber_anggaran') ?>" class="btn btn-warning hvr-shadow top" style="margin-left: 10px;"><i class="fa fa-times"></i> Reset</a>
                            </div>
                        </div>
...
var chart = new Highcharts.Chart({
    ...
    series: [
        <?php foreach ($this->mstatistik->get_sumber_anggaran_rkba_distinct() as $key => $value) { ?>
            {  name:'<?php echo $value->sumber_anggaran ?>', data: [<?php echo $this->mstatistik->dana_by_sumber_anggaran_rkba($value->sumber_anggaran) ?>] },
        <?php } ?>    
    ]
