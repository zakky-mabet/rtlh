			...
			<div class="box-body" style="margin-top: 10px;">
				<div class="col-md-10 col-md-offset-1">
				        ...
				        <div class="wizard">
							 ...
							 * @var string
							 **/
							echo form_open(site_url('data_penerima/ubah/'.$param), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data'));
				                    ...
				                    <div class="tab-pane active" role="tabpanel" id="step1">
				                        ...
				                        <div class="box-body with-border">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="provinsi" class="form-control" value="<?php echo $this->data_penerima->get_nama_provinsi($penduduk->province)->name_provinces; ?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="kabupaten" class="control-label col-md-3 col-xs-12">Kabupaten/kota : <strong class="text-blue">*</strong></label>
												<div class="col-md-6">
													<input type="text" name="kabupaten" class="form-control" value="<?php echo $this->data_penerima->get_nama_kabupaten($penduduk->regency)->name_regencies; ?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="kecamatan" class="control-label col-md-3 col-xs-12">Kecamatan : <strong class="text-blue">*</strong></label>
												<div class="col-md-6">
													<input type="text" name="kecamatan" class="form-control" value="<?php echo $this->data_penerima->get_nama_kecamatan($penduduk->district)->name_districts; ?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="kelurahan" class="control-label col-md-3 col-xs-12">Kelurahan/Desa : <strong class="text-blue">*</strong></label>
												<div class="col-md-6">
													<input type="text" name="provinsi" class="form-control" value="<?php echo $this->data_penerima->get_nama_desa($penduduk->village)->name_villages; ?>" disabled>
												</div>
											</div>
											<div class="form-group">
				                        ...
				                        <hr>
				                         ...
				                         <div class="box-body with-border">
				                        	<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="jenis"  class="form-control" value="<?php echo $dana_bantuan->jenis ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="number" name="tahun_anggaran" maxlength="4"  class="form-control" value="<?php echo $dana_bantuan->tahun_anggaran ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="number" name="nilai"  class="form-control" value="<?php echo $dana_bantuan->nilai ?>">
				                        ...
				                        <hr>
				                         ...
				                         <div class="box-body with-border">
				                        	...
				                        	<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_atap"  class="form-control" value="<?php echo $aspek_bantuan->rehab_atap ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_pondasi"  class="form-control" value="<?php echo $aspek_bantuan->rehab_pondasi ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_dinding"  class="form-control" value="<?php echo $aspek_bantuan->rehab_dinding ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_lantai"  class="form-control" value="<?php echo $aspek_bantuan->rehab_lantai ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_kamar_mandi"  class="form-control" value="<?php echo $aspek_bantuan->rehab_kamar_mandi ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_pintu"  class="form-control" value="<?php echo $aspek_bantuan->rehab_pintu ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_jendela"  class="form-control" value="<?php echo $aspek_bantuan->rehab_jendela ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_kolom_dan_balok"  class="form-control" value="<?php echo $aspek_bantuan->rehab_kolom_dan_balok ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="rehab_dapur"  class="form-control" value="<?php echo $aspek_bantuan->rehab_dapur ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="sumber_penerangan"  class="form-control" value="<?php echo $aspek_bantuan->sumber_penerangan ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="sumber_air_minum"  class="form-control" value="<?php echo $aspek_bantuan->sumber_air_minum ?>">
				                        ...
				                        <hr>
				                         ...
				                         <div class="box-body with-border">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" id="datepicker" name="tanggal_mulai"  class="form-control" value="<?php echo $realisasi_bantuan->tanggal_mulai ?>"> 
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" id="datepicker1" name="tanggal_selesai"  class="form-control" value="<?php echo $realisasi_bantuan->tanggal_selesai; ?>"> 
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea name="deskripsi" id="" cols="20" rows="10" class="form-control"><?php echo $realisasi_bantuan->deskripsi_aspek_bantuan ?></textarea>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="keterangan"  class="form-control" value="<?php echo $realisasi_bantuan->keterangan ?>"> 
