							...
							<?php foreach ($this->data_candidate->foto_rumah($param,'sebelum') as $key => $value): ?>
								<tr>
									...
									<td style="vertical-align: middle;">
										<figure>
											<img class="img-responsive" src="<?php echo base_url('assets/rtlh/img/rumah/'.$value->foto) ?>" alt="<?php echo $value->nama ?>" />
										    <figcaption><?php echo $value->nama ?><small>Kategori : Rumah Sebelum Rehabilitasi</small></figcaption>
										</figure>
									</td>
							...
							<?php foreach ($this->data_candidate->foto_rumah($param,'setelah') as $key => $value): ?>
								<tr>
									...
									<td style="vertical-align: middle;">
										<figure>
											<img class="img-responsive" src="<?php echo base_url('assets/rtlh/img/rumah/'.$value->foto) ?>" alt="<?php echo $value->nama ?>" />
										    <figcaption><?php echo $value->nama ?><small>Kategori : Rumah Setelah Rehabilitasi</small></figcaption>
										</figure>
									</td>
									<td style="vertical-align: middle;"><?php echo $value->nama ?></td>
									<td class="text-center " style="vertical-align: middle;"><a class="icon-button text-red get-delete-foto" data-id="<?php echo $value->id_foto_rumah; ?>" data-nik="<?php echo $value->nik; ?>" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash-o"></i></a></td>
