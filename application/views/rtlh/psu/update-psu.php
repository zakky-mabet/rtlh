...
?>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="text" name="item_pekerjaan" class="form-control" value="<?php echo $get->item_pekerjaan; ?>">
			...
			<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="deskripsi" class="form-control"><?php echo $get->deskripsi; ?></textarea>
