...
?>
				...
				<label for="kategori" class="control-label col-md-3 col-xs-12">Kategori : <strong class="text-red">*</strong></label>
					<div class="col-md-8">
						<select name="kategori" class="form-control select2" style="width: 100%">
							...
							<option <?php if($this->input->post('kategori')=='Pengembang') echo 'selected'; ?> value="Pengembang">Pengembang
							<option <?php if($this->input->post('kategori')=='Pihak Ketiga') echo 'selected'; ?> value="Pihak Ketiga">Pihak Ketiga
						</select>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<textarea name="alamat_kantor" rows="5" class="form-control"><?php echo set_value('alamat_kantor'); ?></textarea>
