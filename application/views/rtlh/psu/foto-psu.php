<div class="row">
	...
	<?php
	echo form_open(site_url('psu/foto/'.$param), array('enctype' => 'multipart/form-data'));
	?>
	<div class="col-md-12">
			...
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="col-md-3">
					<div class="form-group pull-left">
						...
						<a class="btn btn-default  margin-top-23" href="<?php echo base_url('psu') ?>" > <i class="fa fa-repeat"></i> Kembali</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="box-body gallery">
				<table class="table table-hover table-bordered ">
					...
					<tbody>
						...
						<?php else: ?>
						<?php foreach ($this->psu->foto($param) as $key => $value): ?>
						<tr>
							<td style="vertical-align: middle;" class="text-center"><?php echo ++$key ?></td>
							<td  width="300" style="vertical-align: middle;">
								<figure>
									<img class="img-responsive" src="<?php echo base_url('assets/rtlh/img/foto_psu/'.$value->foto) ?>" alt="<?php echo $value->nama ?>" />
									<figcaption><small><?php echo $value->nama?></small></figcaption>
								</figure>
							</td>
							<td style="vertical-align: middle;"><?php echo $value->nama ?></td>
							<td class="text-center " style="vertical-align: middle;"><a class="icon-button text-red get-delete-foto-psu" data-id="<?php echo $value->id; ?>" data-back="<?php echo $value->id_data_psu; ?>" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash-o"></i></a></td>
						</tr>
						<?php endforeach ?>
						<?php endif ?>
...
<div class="modal animated fadeIn modal-danger" id="modal-delete-foto-psu" tabindex="-1" data-backdrop="static" data-keyboard="false">
