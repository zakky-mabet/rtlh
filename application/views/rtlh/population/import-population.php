 ...
 * @var string
 **/
echo form_open_multipart(site_url('population/set_upload'), array('class' => 'form-horizontal'))	
?>
				...
				<div class="form-group pad">
					<div class="col-md-12">
			           <div class="callout callout-default">
			               ...
			               <a href="<?php echo base_url("assets/public/files/CONTOH-IMPOR-PENDUDUK.xlsx") ?>" target="_blank" class="text-blue">Lihat Disini</a></p>
			           </div>
					</div>
				</div>
