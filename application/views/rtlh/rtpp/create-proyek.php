...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="nama_proyek" class="form-control" value="<?php echo set_value('nama_proyek'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="lokasi_proyek" class="form-control"><?php echo set_value('lokasi_proyek'); ?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="status_proyek" class="form-control">
							<option value="">-- PILIH --</option>
							<option value="Provinsi" <?php if($this->input->get('status_proyek')=='Provinsi') echo 'selected'; ?>>Provinsi</option>
				        	<option value="Kabupaten" <?php if($this->input->get('status_proyek')=='Kabupaten') echo 'selected'; ?>>Kabupaten/Kota</option>
				        	<option value="Kecamatan" <?php if($this->input->get('status_proyek')=='Kecamatan') echo 'selected'; ?>>Kecamatan</option>
				        	<option value="Kelurahan" <?php if($this->input->get('status_proyek')=='Kelurahan') echo 'selected'; ?>>Kelurahan/Desa</option>
						</select>
