		...
		<div class="box box-primary">
			...
			<div class="box-body" style="margin-top: 10px;">
					...
					<div class="col-md-9">
						<select name="id_proyek_rtpp" class="form-control select2" style="width: 100%">
							...
							<?php foreach ($this->rtpp->get_all_proyek() as $key => $value): ?>
								<option value="<?php echo $value->id_proyek ?>" <?php if($get->id_proyek_rtpp==$value->id_proyek) echo 'selected'; ?>><?php echo $value->nama_proyek ?>
							<?php endforeach ?>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" name="aksi" placeholder="Contoh : Gusur" class="form-control" value="<?php echo $get->aksi ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea name="lokasi_rumah" class="form-control"><?php echo $get->lokasi_rumah ?></textarea>
					...
					<div class="col-md-9">
						<select name="sumber_anggaran" class="form-control select2" style="width: 100%">
							...
							<?php foreach ($this->muniversal->get_sumber_anggaran() as $key => $value): ?>
								<option value="<?php echo $value->slug ?>" <?php if($get->sumber_anggaran==$value->slug) echo 'selected'; ?>><?php echo $value->nama ?>
							<?php endforeach ?>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="number" name="jumlah_bantuan" class="form-control" value="<?php echo $get->jumlah_bantuan ?>">
