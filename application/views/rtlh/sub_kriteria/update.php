...
?>
			<div class="box-body" style="margin-top: 10px;">
					...
					<div class="col-md-8">
						<select name="kriteria" class="form-control input-sm">
				        	...
				        	<?php foreach ($this->sub_kriteria->get_all_kriteria() as $key => $value): ?>
				        		<option value="<?php echo $value->id ?>" <?php if($value->id== $get->id_kriteria) echo 'selected'; ?>><?php echo $value->nama ?></option>
				        	<?php endforeach ?>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="nilai" class="form-control" value="<?php echo $get->nilai; ?>">
